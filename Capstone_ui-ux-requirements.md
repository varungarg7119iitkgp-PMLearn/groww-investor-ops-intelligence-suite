...
5 staggered expanding concentric rings — fluid, plasmatic effect:

| Property | Value |
|---|---|
| Ring count | 5 (staggered delays 0–1.92s) |
| Start radius | `orbRadius × 1.03–1.07` |
| End radius | `orbRadius × 1.95–2.15` |
| Duration | 2.4s, easeOut, repeat ∞ |
| Stroke | 0.7–1.4px varied widths |
| Opacity | 0.30–0.55 → 0 |
| Color | `--color-investor` |

#### [NEW] Horizontal Voice Wave

Symmetric vertical bars extending left and right, Gaussian height envelope:

| Property | Value |
|---|---|
| Bars per side | 13 |
| Bar width | 3px, pitch 8px |
| Gap from orb | 20px |
| Idle | max 18px height, 25% opacity, 1.8s cycle |
| Active | max 36px height, 65% opacity, 0.5s cycle |
| Color | `--color-investor` |

#### [NEW] Groww Logo Shadow

Groww mountain-wave watermarked inside the sphere:

| Property | Value |
|---|---|
| Upper area fill | `rgba(90, 100, 220, 0.10)` |
| Lower area fill | `rgba(0, 229, 255, 0.12)` |
| Wave outline | `rgba(0, 229, 255, 0.22)`, 1.5px |
| Clip | Orb circle boundary |
